...
recipes['rocket'].ingredients[3][2] = 1
recipes['explosive-rocket'].ingredients[2][2] = 1
...
recipes['artillery-shell'].ingredients[1][2] = 2
...
recipes['defender-capsule'].ingredients[1][2] = 1
recipes['defender-capsule'].ingredients[2][2] = 1
recipes['defender-capsule'].ingredients[3][2] = 1
recipes['distractor-capsule'].ingredients[1][2] = 1
recipes['distractor-capsule'].ingredients[2][2] = 1
recipes['destroyer-capsule'].ingredients[1][2] = 1
recipes['cliff-explosives'].ingredients[1][2] = 3
...
recipes['wooden-chest'].ingredients[1][2] = 1
...
recipes['electric-mining-drill'].normal.ingredients[2][2] = 2
...
recipes['radar'].ingredients[3][2] = 5
recipes['small-lamp'].ingredients[2][2] = 2
recipes['pipe-to-ground'].ingredients[1][2] = 5
...
recipes['lab'].ingredients[1][2] = 3
recipes['lab'].ingredients[2][2] = 3
recipes['lab'].ingredients[3][2] = 1
recipes['stone-wall'].ingredients[1][2] = 2
recipes['assembling-machine-2'].normal.ingredients[1][2] = 1
recipes['assembling-machine-2'].normal.ingredients[2][2] = 2
recipes['assembling-machine-2'].normal.ingredients[3][2] = 2
recipes['splitter'].ingredients[1][2] = 2
recipes['splitter'].ingredients[2][2] = 2
recipes['splitter'].ingredients[3][2] = 1
recipes['underground-belt'].ingredients[1][2] = 4
recipes['underground-belt'].ingredients[2][2] = 3
recipes['loader'].ingredients[1][2] = 2
recipes['loader'].ingredients[2][2] = 2
recipes['loader'].ingredients[3][2] = 2
recipes['loader'].ingredients[4][2] = 2
recipes['loader'].ingredients[5][2] = 2
recipes['car'].ingredients[1][2] = 2
recipes['car'].ingredients[2][2] = 5
recipes['car'].ingredients[3][2] = 1
recipes['engine-unit'].ingredients[3][2] = 1
recipes['iron-chest'].ingredients[1][2] = 3
recipes['big-electric-pole'].ingredients[1][2] = 4
recipes['big-electric-pole'].ingredients[2][2] = 3
recipes['big-electric-pole'].ingredients[3][2] = 3
recipes['medium-electric-pole'].ingredients[1][2] = 2
recipes['medium-electric-pole'].ingredients[2][2] = 1
recipes['medium-electric-pole'].ingredients[3][2] = 1
recipes['shotgun'].ingredients[1][2] = 8
recipes['shotgun'].ingredients[2][2] = 3
recipes['shotgun'].ingredients[3][2] = 5
recipes['shotgun'].ingredients[4][2] = 3
recipes['shotgun-shell'].ingredients[1][2] = 1
recipes['shotgun-shell'].ingredients[2][2] = 1
recipes['piercing-rounds-magazine'].ingredients[3][2] = 2
recipes['grenade'].ingredients[1][2] = 2
recipes['grenade'].ingredients[2][2] = 4
recipes['steel-furnace'].ingredients[1][2] = 3
recipes['steel-furnace'].ingredients[2][2] = 5
recipes['gate'].ingredients[2][2] = 1
recipes['gate'].ingredients[3][2] = 1

-- https://github.com/wube/factorio-data/blob/master/base/prototypes/recipe/demo-turret.lua
recipes['gun-turret'].ingredients[1][2] = 4
recipes['gun-turret'].ingredients[2][2] = 4
recipes['gun-turret'].ingredients[3][2] = 8
...
recipes['belt-immunity-equipment'].ingredients[1][2] = 1
recipes['belt-immunity-equipment'].ingredients[2][2] = 4
...
recipes['energy-shield-mk2-equipment'].ingredients[2][2] = 2
recipes['energy-shield-mk2-equipment'].ingredients[2][2] = 2
recipes['battery-equipment'].ingredients[1][2] = 1
recipes['battery-equipment'].ingredients[2][2] = 4
recipes['battery-mk2-equipment'].ingredients[1][2] = 4
recipes['battery-mk2-equipment'].ingredients[2][2] = 5
recipes['battery-mk2-equipment'].ingredients[3][2] = 2
recipes['solar-panel-equipment'].ingredients[2][2] = 1
recipes['solar-panel-equipment'].ingredients[3][2] = 2
recipes['fusion-reactor-equipment'].ingredients[1][2] = 50
recipes['fusion-reactor-equipment'].ingredients[2][2] = 10
recipes['personal-laser-defense-equipment'].ingredients[1][2] = 5
recipes['personal-laser-defense-equipment'].ingredients[2][2] = 1
recipes['personal-laser-defense-equipment'].ingredients[3][2] = 1
recipes['discharge-defense-equipment'].ingredients[1][2] = 1
recipes['discharge-defense-equipment'].ingredients[2][2] = 5
recipes['discharge-defense-equipment'].ingredients[3][2] = 2
recipes['exoskeleton-equipment'].ingredients[1][2] = 4
recipes['exoskeleton-equipment'].ingredients[2][2] = 12
recipes['exoskeleton-equipment'].ingredients[3][2] = 8
recipes['personal-roboport-equipment'].ingredients[1][2] = 3
recipes['personal-roboport-equipment'].ingredients[2][2] = 10
recipes['personal-roboport-equipment'].ingredients[3][2] = 5
recipes['personal-roboport-equipment'].ingredients[4][2] = 12
recipes['personal-roboport-mk2-equipment'].ingredients[1][2] = 2
recipes['personal-roboport-mk2-equipment'].ingredients[2][2] = 20
recipes['personal-roboport-mk2-equipment'].ingredients[3][2] = 4
...
recipes['coal-liquefaction'].ingredients[2].amount = 15
recipes['coal-liquefaction'].ingredients[2].amount = 30
recipes['heavy-oil-cracking'].ingredients[2].amount = 20
recipes['light-oil-cracking'].ingredients[2].amount = 15
recipes['sulfuric-acid'].ingredients[1].amount = 2
...
recipes['sulfur'].ingredients[2].amount = 15
recipes['lubricant'].ingredients[1].amount = 5
...
recipes['player-port'].ingredients[1][2] = 3
recipes['player-port'].ingredients[2][2] = 2
recipes['fast-transport-belt'].ingredients[1][2] = 1
recipes['express-transport-belt'].normal.ingredients[1][2] = 2
recipes['express-transport-belt'].normal.ingredients[3].amount = 5
...
recipes['tank'].normal.ingredients[1][2] = 6
recipes['tank'].normal.ingredients[2][2] = 20
recipes['tank'].normal.ingredients[3][2] = 10
recipes['tank'].normal.ingredients[4][2] = 4
recipes['locomotive'].ingredients[1][2] = 8
recipes['locomotive'].ingredients[2][2] = 4
recipes['locomotive'].ingredients[3][2] = 20
recipes['cargo-wagon'].ingredients[1][2] = 4
recipes['cargo-wagon'].ingredients[2][2] = 8
recipes['cargo-wagon'].ingredients[3][2] = 8
recipes['fluid-wagon'].ingredients[1][2] = 4
recipes['fluid-wagon'].ingredients[2][2] = 6
recipes['fluid-wagon'].ingredients[3][2] = 3
recipes['artillery-wagon'].ingredients[1][2] = 16
recipes['artillery-wagon'].ingredients[2][2] = 4
recipes['artillery-wagon'].ingredients[3][2] = 20
recipes['artillery-wagon'].ingredients[4][2] = 8
recipes['artillery-wagon'].ingredients[5][2] = 8
recipes['train-stop'].ingredients[1][2] = 2
recipes['train-stop'].ingredients[2][2] = 3
recipes['train-stop'].ingredients[3][2] = 3
recipes['train-stop'].ingredients[4][2] = 1
recipes['rail-signal'].ingredients[2][2] = 3
recipes['rail-chain-signal'].ingredients[2][2] = 3
recipes['heavy-armor'].ingredients[1][2] = 25
recipes['heavy-armor'].ingredients[2][2] = 13
recipes['modular-armor'].ingredients[1][2] = 10
recipes['modular-armor'].ingredients[2][2] = 20
recipes['power-armor'].ingredients[1][2] = 20
recipes['power-armor'].ingredients[2][2] = 10
recipes['power-armor'].ingredients[3][2] = 20
recipes['power-armor-mk2'].ingredients[1][2] = 10
recipes['power-armor-mk2'].ingredients[2][2] = 10
recipes['power-armor-mk2'].ingredients[3][2] = 30
recipes['power-armor-mk2'].ingredients[4][2] = 20
recipes['power-armor-mk2'].ingredients[5][2] = 15
recipes['steel-chest'].ingredients[1][2] = 3
...
recipes['combat-shotgun'].ingredients[1][2] = 6
recipes['railgun'].ingredients[1][2] = 10
recipes['railgun'].ingredients[2][2] = 10
recipes['railgun'].ingredients[3][2] = 6
recipes['railgun'].ingredients[4][2] = 3
...
recipes['express-underground-belt'].ingredients[3].amount = 10
recipes['fast-loader'].ingredients[1][2] = 2
recipes['express-loader'].ingredients[1][2] = 2
recipes['fast-splitter'].ingredients[2][2] = 2
recipes['fast-splitter'].ingredients[3][2] = 2
recipes['express-splitter'].ingredients[2][2] = 2
...
recipes['accumulator'].ingredients[2][2] = 3
recipes['electric-furnace'].ingredients[1][2] = 5
recipes['electric-furnace'].ingredients[2][2] = 3
recipes['electric-furnace'].ingredients[3][2] = 5
...
recipes['oil-refinery'].ingredients[1][2] = 8
recipes['oil-refinery'].ingredients[2][2] = 5
recipes['oil-refinery'].ingredients[3][2] = 5
recipes['oil-refinery'].ingredients[4][2] = 5
recipes['oil-refinery'].ingredients[5][2] = 5
recipes['engine-unit'].ingredients[3][2] = 1
...
recipes['explosives'].normal.ingredients[3].amount = 5
...
recipes['small-plane'].ingredients[1][2] = 50
recipes['small-plane'].ingredients[2][2] = 100
recipes['small-plane'].ingredients[3][2] = 10
recipes['small-plane'].ingredients[4][2] = 50
...
recipes['programmable-speaker'].ingredients[1][2] = 1
recipes['programmable-speaker'].ingredients[2][2] = 2
recipes['programmable-speaker'].ingredients[3][2] = 4
recipes['programmable-speaker'].ingredients[4][2] = 1
recipes['low-density-structure'].normal.ingredients[1][2] = 1
recipes['low-density-structure'].normal.ingredients[2][2] = 5
recipes['low-density-structure'].normal.ingredients[3][2] = 2
recipes['rocket-fuel'].ingredients[1][2] = 4
recipes['rocket-fuel'].ingredients[2].amount = 4
...
recipes['satellite'].ingredients[4][2] = 2
recipes['satellite'].ingredients[5][2] = 50
recipes['satellite'].ingredients[6][2] = 25
recipes['concrete'].ingredients[1][2] = 3
recipes['concrete'].ingredients[3].amount = 50
recipes['refined-concrete'].ingredients[1][2] = 10
recipes['refined-concrete'].ingredients[2][2] = 4
recipes['refined-concrete'].ingredients[4].amount = 50
recipes['landfill'].ingredients[1][2] = 10
recipes['electric-energy-interface'].ingredients[1][2] = 1
recipes['electric-energy-interface'].ingredients[2][2] = 3
...
recipes['kovarex-enrichment-process'].results[1].amount = 6
recipes['kovarex-enrichment-process'].results[2].amount = 1
...
recipes['uranium-fuel-cell'].result_count = 15
recipes['heat-exchanger'].ingredients[1][2] = 2
recipes['heat-exchanger'].ingredients[2][2] = 20
recipes['heat-exchanger'].ingredients[3][2] = 2
recipes['heat-pipe'].ingredients[1][2] = 2
recipes['heat-pipe'].ingredients[2][2] = 4
...
recipes['flamethrower-turret'].ingredients[1][2] = 10
recipes['flamethrower-turret'].ingredients[2][2] = 8
recipes['flamethrower-turret'].ingredients[3][2] = 4
recipes['flamethrower-turret'].ingredients[4][2] = 3
recipes['artillery-turret'].ingredients[1][2] = 20
recipes['artillery-turret'].ingredients[2][2] = 20
recipes['artillery-turret'].ingredients[3][2] = 16
recipes['artillery-turret'].ingredients[4][2] = 8
